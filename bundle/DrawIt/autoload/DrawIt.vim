...
"lidong cha.
  ...
  nmap <silent> <buffer> <script> \>		:set lz<CR>:silent! call <SID>DrawFatRArrow()<CR>:set nolz<CR>
  nmap <silent> <buffer> <script> \<		:set lz<CR>:silent! call <SID>DrawFatLArrow()<CR>:set nolz<CR>
  nmap <silent> <buffer> <script> \^		:set lz<CR>:silent! call <SID>DrawFatUArrow()<CR>:set nolz<CR>
  nmap <silent> <buffer> <script> \v		:set lz<CR>:silent! call <SID>DrawFatDArrow()<CR>:set nolz<CR>
"lidong end
...
"lidong cha.
  ...
  vmap     <silent> <buffer> <script> \a  :<c-u>call <SID>CallBox('Arrow')<CR>
  vmap     <silent> <buffer> <script> \b  :<c-u>call <SID>CallBox('DrawBox')<cr>
  nmap              <buffer> <script> \c  :call <SID>Canvas()<cr>
  vmap     <silent> <buffer> <script> \l  :<c-u>call <SID>CallBox('DrawPlainLine')<CR>
  vmap     <silent> <buffer> <script> \s  :<c-u>call <SID>Spacer(line("'<"), line("'>"),0)<cr>
"lidong end.
...
"lidong cha.
  ...
  vmap <buffer> <silent> \e   :<c-u>call <SID>CallBox('DrawEllipse')<CR>
"lidong end.
  ...
  while strlen(allreg) > 0
   ...
   exe "nmap <silent> <buffer> \p".ireg.'  :<c-u>set lz<cr>:silent! call <SID>PutBlock("'.ireg.'",0)<cr>:set nolz<cr>'
   exe "nmap <silent> <buffer> \r".ireg.'  :<c-u>set lz<cr>:silent! call <SID>PutBlock("'.ireg.'",1)<cr>:set nolz<cr>'
   "lidong end.
